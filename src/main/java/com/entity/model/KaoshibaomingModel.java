...
public class KaoshibaomingModel  implements Serializable {
	...
	public void setKaoshishenqing(String kaoshishenqing) {
		this.kaoshishenqing = kaoshishenqing;
	}
	
	/**
	 * 获取：考试申请
	 */
	public String getKaoshishenqing() {
		return kaoshishenqing;
	}
