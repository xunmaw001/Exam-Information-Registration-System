	...
	<div class="list" :style='{"padding":"0","margin":"20px 7% 10px 7%","background":"none","flex":"1","width":"86%","minWidth":"850px","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0","background":"none","display":"block","height":"auto"}'>
			<div :style='{"cursor":"pointer","margin":"0 0 40px 2%","flexWrap":"wrap","background":"none","display":"flex","width":"31%","position":"relative","float":"left","justifyContent":"space-between","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"30px","fontSize":"16px","textOverflow":"ellipsis"}' class="name ">{{item.jiaoshixingming}}</div>
				<div :style='{"padding":"4px 10px","whiteSpace":"nowrap","overflow":"hidden","color":"#333","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"30px","fontSize":"16px","textOverflow":"ellipsis"}' class="name ">性别:{{item.xingbie}}</div>
			</div>
		</div>
